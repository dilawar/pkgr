...
IMAGES = dict(
    opensuse={"default": "opensuse/tumbleweed", "15.3": "opensuse/leap:15.3"},
    centos={"default": "centos:latest", "8": "centos:8", "7": "centos:7"},
    fedora={"default": "fedora:latest"},
    ubuntu={
...
def get_image(distribution: str, release: str = "default") -> str:
    global IMAGES
